...
int main(void){
    ...
    float RpX[3][3],RmX[3][3],RpY[3][3],RmY[3][3],wrong[3][3],Rroll[3][3],Rpitch[3][3];
    ...
    puts("PASS R8R28 five-pose +/-pair mount calibration + sign rejection + rocket-frame transform");
    return 0;
}
