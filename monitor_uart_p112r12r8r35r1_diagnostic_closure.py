...
def run(a):
    ...
    p83_ok=(not p83_invalid_seen and (p83_pair_reject0 is not None) and iv(latest,'p83_adc_timeout_count')==p83_timeout0)
    ...
    print('\n================ R8R35R1 DIAGNOSTIC CLOSURE OZET ================')
    ...
    print('\nSONUC:', 'PASS - R8R35R1 DIAGNOSTIC CLOSURE' if ok else 'INCELE - R8R35R1 diagnostik gate tamamlanmadi')
    ...
    if needle_fault: print('UYARI: Needle fault tekrarlandi; P83 FIRST BAD satiri feedback-valid kokenini ayirir.')
...
def main():
    ...
    p.add_argument('--log',default='uart_p112r12r8r35r1_diagnostic_closure.txt'); p.add_argument('--capture'); p.add_argument('--print-every',type=int,default=2)
