    ...
    try:
        with serial.Serial(port, baudrate=baud, timeout=1.0) as connection:
            ...
            try:
                ...
                pass
            print(f"# P112 UART-independent deterministic adaptive diagnostic | port={port} baud={baud} fields={len(FIELDS)}")
...
def main() -> int:
    ...
    try:
        if log_file is not None:
            ...
            header = (
                f"# P112 UART-independent deterministic adaptive diagnostic | port={selected_port} "
