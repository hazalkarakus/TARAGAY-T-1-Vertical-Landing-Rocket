...
extern volatile uint32_t sdio_dma_irq_count;
...
/**
  * @brief This function handles EXTI line3 interrupt (nRF24 IRQ on PD3).
  */
 ...
 * Deterministic 1000 Hz needle-valve loop and V49 RCS pulse timer.
  */
