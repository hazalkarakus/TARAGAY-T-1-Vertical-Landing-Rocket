...
checks=[
('version',has('App/Common/app_version.h','8.19M-P112R12R8-PRODUCTION-CANDIDATE-INERT-DRYRUN')),
('project name',has('.project','<name>P112R12R8_PRODUCTION_CANDIDATE_INERT_DRYRUN</name>')),
...
('do not fly',(R/'P112R12R8_DO_NOT_FLY.txt').is_file()),
('start doc',(R/'00_START_HERE_P112R12R8_TR.md').is_file()),
('monitor',(R/'monitor_uart_p112r12r8_production_candidate_inert.py').is_file()),
]
...
subprocess.run([sys.executable,'-m','py_compile',str(R/'monitor_uart_p112r12r8_production_candidate_inert.py')],check=True,env=env)
...
print('P112R12R8 production-candidate inert static/host validation: PASS')
